...
//            $header = self::parseHeaders($header);
    ...
    private static function packData($apiReturnData) {
        ...
        if (isset($apiReturnData['statusCode']) && $apiReturnData['statusCode'] != '0x00000000') {

            self::setError($apiReturnData['statusCode'],$apiReturnData['msg'],isset($apiReturnData['data'])?$apiReturnData['data']:null);
     ...
     */
    protected static function setError($code, $msg = '',$data = null) {
        self::$errorCode = $code;
        self::$errorMsg = $msg;
        self::$errorData = $data;
    }
